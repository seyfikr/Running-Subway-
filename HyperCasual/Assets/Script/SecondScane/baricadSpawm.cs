...
public class baricadSpawm : MonoBehaviour
{
    int Spawm;
    ...
    void Start()
    {
        ...
        InvokeRepeating("ObjectClone", 0, 1.1f);
    ...
    public void Clon(GameObject Object, float y_coordinate)
    {
        ...
        //NewClon.transform.position = new Vector3(0.18f, y_coordinate, Character.position.z + SpawmDistance);    
        //Destroy(NewClon, 15f);
        if (SpawmLevel > 0)
        {
